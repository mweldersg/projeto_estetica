    ...
    <section className="relative min-h-screen flex items-center justify-center text-center pt-20">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4">
        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 uppercase tracking-wide">
          Seu Carro, <span className="text-garage-gold">Impecável</span>, Protegido & Mais Bonito
        </h1>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
          <Link
            href="#booking"
            onClick={onBookClick}
            className="px-8 py-4 bg-garage-gold text-black font-bold uppercase rounded hover:bg-garage-gold-hover transition-all shadow-lg hover:shadow-garage-gold/30"
          >
            Agendar Avaliação
          </Link>
          <Link
            href="#services"
            className="px-8 py-4 border-2 border-garage-gold text-garage-gold font-bold uppercase rounded hover:bg-garage-gold/10 transition-all"
          >
            Ver Serviços
          </Link>
        </div>

        <div className="flex flex-col sm:flex-row justify-center gap-6 text-sm font-semibold text-garage-gold">
