    ...
    <div className="w-full max-w-sm mx-auto">
      <div className="bg-garage-dark border border-garage-border rounded-2xl overflow-hidden">
        <div className="flex items-center gap-4 p-5 border-b border-garage-border">
          <span className="w-16 h-16 rounded-full overflow-hidden border-2 border-garage-gold shrink-0">
            <img
        ...
        <div className="p-5">
          <Link
            ...
            className="block w-full py-3 text-center bg-garage-gold text-black font-semibold rounded-lg hover:bg-garage-gold-hover transition-colors"
          >
            Seguir no Instagram
          </Link>
        </div>
