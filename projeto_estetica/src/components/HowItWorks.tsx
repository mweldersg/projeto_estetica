    ...
    <section className="py-20 bg-garage-dark">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
          Um Processo <span className="text-garage-gold">Simples & Transparente</span>
        </h2>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          {steps.map((step) => (
            <div key={step.number} className="text-center">
              <div className="w-14 h-14 bg-garage-gold text-black rounded-full flex items-center justify-center text-xl font-extrabold mx-auto mb-4">
                {step.number}
              </div>
