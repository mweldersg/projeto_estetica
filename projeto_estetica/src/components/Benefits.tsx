export default function Benefits() {
  const benefits = [
    {
      icon: (
        <svg className="w-10 h-10 text-garage-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section className="py-20 bg-garage-card">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">
          Por que escolher a <span className="text-garage-gold">Garage 765</span>?
        </h2>
